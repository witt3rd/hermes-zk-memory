...
corpus of Markdown notes and returns ranked hits. Used by ``zk.py`` when
lancedb is available; otherwise recall degrades to ripgrep. The index is a
derived cache owned by the plugin, stored beside the corpus.
